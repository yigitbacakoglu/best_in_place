...
BestInPlaceEditor.prototype = {
    ...
    initOptions: function () {
        ...
        self.element.parents().each(function () {
            ...
            self.paramName = self.paramName || $parent.attr("data-param-name");
        ...
        self.paramName = self.element.attr("data-param-name") || self.paramName;
    ...
    requestData: function () {
        ...
        if (this.paramName != undefined) {
            data += "&" + this.paramName + '=' + encodeURIComponent(this.getValue());
        } else {
    ...
    startedCall: function () {
        this.element.trigger(jQuery.Event("best_in_place:startedCall"));
    },
    endedCall: function () {
        this.element.trigger(jQuery.Event("best_in_place:endedCall"));
